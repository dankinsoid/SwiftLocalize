...
// Generated by Scripts/GenerateLocaleData from CLDR data.
...
internal enum LocaleData {
	...
	static let likelySubtagsCommon: [String: String] = [
		"ar": "ar-Arab-EG",
		"bg": "bg-Cyrl-BG",
		"bn": "bn-Beng-BD",
		"ca": "ca-Latn-ES",
	...
	static let likelySubtagsRare: [(String, String)] = LocaleData.parsePairs(_likelySubtagsRareRaw)
	private static let _likelySubtagsRareRaw: String = """
	aa	aa-Latn-ET
	aaa	aaa-Latn-NG
	aab	aab-Latn-NG
	aac	aac-Latn-PG
	...
	static let parentLocales: [String: String] = LocaleData.parseDict(_parentLocalesRaw)
	private static let _parentLocalesRaw: String = """
	az-Arab	und
	az-Cyrl	und
	bal-Latn	und
	blt-Latn	und
	...
	static let languageAliases: [String: String] = LocaleData.parseDict(_languageAliasesRaw)
	private static let _languageAliasesRaw: String = """
	aa-saaho	ssy
	aam	aas
	aar	aa
	abk	ab
	...
	static let scriptAliases: [String: String] = [
		"Qaai": "Zinh",
	]

	/// Deprecated region-subtag replacements. "BU" → "MM", "SU" → "RU" (first of CLDR's ordered list).
	static let regionAliases: [String: String] = LocaleData.parseDict(_regionAliasesRaw)
	private static let _regionAliasesRaw: String = """
	004	AF
	008	AL
	010	AQ
	012	DZ
