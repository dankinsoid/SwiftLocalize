...
// 	/// Wrap `text` in this scope's language's quotation marks. Equivalent to
// 	/// `text.quoted(in: language, level: level)` — the helper just removes the
// 	/// language argument because it's already in scope.
// 	func quoted(_ text: String, level: Int = 0) -> String {
// 		text.quoted(in: language, level: level)
// 	}
// }
