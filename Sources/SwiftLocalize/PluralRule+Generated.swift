...
public extension PluralRule {
	...
	fileprivate static let _bal: Self = .init(
		cardinal: { n in
			let absN = abs(n)
			if absN == 1 { return .one }
			return .other
	...
	fileprivate static let _blo: Self = .init(
		cardinal: { n in
			let absN = abs(n)
			if absN == 0 { return .zero }
			if absN == 1 { return .one }
		...
		ordinal:  { n in
			...
			if i == 0 { return .zero }
			if i == 1 { return .one }
			if (i == 2 || i == 3 || i == 4 || i == 5 || i == 6) { return .few }
			return .other
		}
	)
	...
	fileprivate static let _ca: Self = .init(
		cardinal: { n in
			...
			let isInteger = absN == Double(i)
			if (i == 1) && (isInteger) { return .one }
			if (i != 0) && ((i % 1000000) == 0) && (isInteger) { return .many }
			return .other
		},
		ordinal:  { n in
			let absN = abs(n)
	...
	fileprivate static let _csw: Self = .init(
		cardinal: { n in
			let absN = abs(n)
			if (0.0 ... 1.0).contains(absN) { return .one }
			return .other
	...
	fileprivate static let _cv: Self = .init(
		cardinal: { n in
			let absN = abs(n)
			if absN == 0 { return .zero }
			if absN == 1 { return .one }
	...
	fileprivate static let _doi: Self = .init(
		cardinal: { n in
			let absN = abs(n)
			let i = Int(absN.rounded(.down))
			if (i == 0) || (absN == 1) { return .one }
	...
	fileprivate static let _he: Self = .init(
		cardinal: { n in
			...
			let i = Int(absN.rounded(.down))
			let isInteger = absN == Double(i)
			if ((i == 1) && (isInteger)) || ((i == 0) && (!isInteger)) { return .one }
	...
	fileprivate static let _hnj: Self = .init(
		cardinal: { _ in .other },
		ordinal:  { _ in .other }
	)
	...
	fileprivate static let _ie: Self = .init(
		cardinal: { n in
			let absN = abs(n)
			let i = Int(absN.rounded(.down))
			let isInteger = absN == Double(i)
	...
	fileprivate static let _kok: Self = .init(
		cardinal: { n in
			let absN = abs(n)
			let i = Int(absN.rounded(.down))
			if (i == 0) || (absN == 1) { return .one }
	...
	fileprivate static let _kok_Latn: Self = .init(
		cardinal: { n in
			let absN = abs(n)
			let i = Int(absN.rounded(.down))
			if (i == 0) || (absN == 1) { return .one }
	...
	fileprivate static let _lij: Self = .init(
		cardinal: { n in
			let absN = abs(n)
			let i = Int(absN.rounded(.down))
			let isInteger = absN == Double(i)
		...
		ordinal:  { n in
			let absN = abs(n)
			if (absN == 11 || absN == 8 || (80.0 ... 89.0).contains(absN) || (800.0 ... 899.0).contains(absN)) { return .many }
			return .other
		}
	)
	...
	fileprivate static let _lld: Self = .init(
		cardinal: { n in
			let absN = abs(n)
			let i = Int(absN.rounded(.down))
			let isInteger = absN == Double(i)
	...
	fileprivate static let _mo: Self = .init(
		cardinal: { n in
			...
			let isInteger = absN == Double(i)
			if (i == 1) && (isInteger) { return .one }
			if (!isInteger) || (absN == 0) || ((absN != 1) && ((1.0 ... 19.0).contains(absN.truncatingRemainder(dividingBy: 100)))) { return .few }
			return .other
		},
		ordinal:  { n in
			let absN = abs(n)
	...
	fileprivate static let _mt: Self = .init(
		cardinal: { n in
			...
			if absN == 1 { return .one }
			if absN == 2 { return .two }
			if (absN == 0) || ((3.0 ... 10.0).contains(absN.truncatingRemainder(dividingBy: 100))) { return .few }
	...
	fileprivate static let _sgs: Self = .init(
		cardinal: { n in
			let absN = abs(n)
			if (absN.truncatingRemainder(dividingBy: 10) == 1) && (absN.truncatingRemainder(dividingBy: 100) != 11) { return .one }
			if absN == 2 { return .two }
			if (absN != 2) && ((2.0 ... 9.0).contains(absN.truncatingRemainder(dividingBy: 10))) && (!(11.0 ... 19.0).contains(absN.truncatingRemainder(dividingBy: 100))) { return .few }
			return .other
		},
		ordinal:  { _ in .other }
	)
	...
	fileprivate static let _tpi: Self = .init(
		cardinal: { _ in .other },
		ordinal:  { _ in .other }
	)
	...
	fileprivate static let _und: Self = .init(
		cardinal: { _ in .other },
		ordinal:  { _ in .other }
	)
	...
	fileprivate static let _vec: Self = .init(
		cardinal: { n in
			let absN = abs(n)
			let i = Int(absN.rounded(.down))
			let isInteger = absN == Double(i)
